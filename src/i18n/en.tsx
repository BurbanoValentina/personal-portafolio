...
export const en: Translations = {
  ...
  hero: {
    ...
    heading4: "precision.",
    description: "Hi, I'm Valentina Burbano, a Full Stack Software Engineering student at UCC. I'm passionate about building scalable, high-performance applications, combining dynamic JavaScript frontends with robust C# and Java backends. I also design interactive videogames and create innovative, user-centered solutions with strong attention to detail.",
  ...
  about: {
    ...
    bio1: "I specialize in full-stack development for web and mobile applications. I build dynamic, responsive interfaces with React, Next.js, TypeScript, and Angular, with a strong focus on performance and user experience.",
    bio2: "On the backend, I develop scalable systems with C#, Java, Spring Boot, Node.js, and Django, integrating PostgreSQL, MongoDB, MySQL, and SQLite. I complement this stack with Docker, AWS, Azure, Vercel, and GitHub Actions for reliable deployments.",
    bio3: "Beyond coding, I serve as Engineering Faculty Representative at UCC (2025-2027), work as a Chess Instructor, and contribute as a University Well-being Monitor. As a professional chess player, I apply strategic thinking and analytical skills to software engineering.",
  ...
  projects: {
    ...
    subtitle: "A selection of recent projects, from complex web applications to innovative tools that solve real-world problems.",
  ...
  experience: {
    ...
    subtitle: "A timeline of my professional growth, from curious student to active contributor in products and communities.",
  ...
  testimonials: {
    ...
    subtitle: "Real stories of collaboration, commitment, and results in projects where I contributed value.",
    items: [
      {
  ...
  processAndGrowth: {
    ...
    subtitle: "A professional approach based on agile methodologies and SOLID principles, supported by a continuous improvement mindset.",
    steps: [
      {
        title: "Requirements",
  ...
  contact: {
    ...
    subtitle: "Have a project in mind? I'd love to hear about it. Send me a message and let's discuss how we can work together.",
    fields: {
      name: "Name",
      email: "Email",
      phone: "Phone",
    ...
    availabilityText: "I usually respond within",
    availabilityText2: "hours",
    availableNow: "Currently available for new projects",
    validation: {
      ...
      nameRepeat: "Name contains too many repeated characters.",
      emailRequired: "Email is required.",
      emailInvalid: "Please enter a valid email.",
      emailTooLong: "Email is too long.",
      phoneDigitsOnly: "Phone can only contain numbers.",
      phoneLength: "Phone must have between 7 and 15 digits.",
      phoneRepeat: "Phone cannot be all repeated digits.",
      subjectRequired: "Subject is required.",
      subjectMin: "Subject must be at least 3 characters.",
      subjectMax: "Subject must be at most 120 characters.",
      subjectRepeat: "Subject contains too many repeated characters.",
